...
bowtie -k 1 -n 2 --best -p $num_threads ./plasmid_reference/ref ./trimmed.fastq.gz -S ./alignment/aligned2plasmid.sam --un ./no_plasmid_reads.fastq

# Map the reads unaligned to the plasmid to the genome
bowtie -k 1 -n 2 --best -p $num_threads ./genome_reference/ref ./no_plasmid_reads.fastq -S ./alignment/aligned2genome.sam
